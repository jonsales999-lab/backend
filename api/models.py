...
if not DATABASE_URL:
    raise RuntimeError("DATABASE_URL não definida em .env ou no ambiente")
...
try:
    ...
    # In serverless environments we often don't have DB connectivity at import time.
    # Avoid crashing the function — migrations or initialisation should be run separately.
    pass
